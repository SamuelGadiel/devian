...
- **Fuso horário**: banco armazena UTC (timestamptz); a API retorna **todas** as datas em **hora de Brasília com sufixo Z** — `2026-08-05T17:44:40Z` (sem fração). Contrato com o app: o número já é o horário local; `DateTime.parse(...)` direto, sem conversão.
